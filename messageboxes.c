...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
   ...
   HWND hwnd;
  	...
  	RegisterClassW(&wc);
  	hwnd = CreateWindowW(wc.lpszClassName, L"Window",WS_OVERLAPPEDWINDOW | WS_VISIBLE,8000, 8000, 250, 150, NULL, NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
  	...
  	switch(msg) {
   	...
   	case WM_CREATE:
          	...
          	CreateWindowW(L"button", L"Show dialog",WS_VISIBLE | WS_CHILD ,20, 50, 95, 25, hwnd, (HMENU) 1, NULL, NULL);
          break;
